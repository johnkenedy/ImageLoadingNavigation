...
class DestinationDataSourceImpl : DestinationDataSource {

    override fun getDestinations(): Flow<List<Destination>> = flow {
        delay(1000L)
        emit(destinations)
    }
